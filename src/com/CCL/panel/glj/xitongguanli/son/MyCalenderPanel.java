...
import com.CCL.util.glj.DateUtil;
	...
	public class MyCalenderPanel extends JPanel {
	    ...
	    private final class DayClientListener extends MouseAdapter {
	        ...
	        public void mousePressed(MouseEvent e) {
	            ...
	            {
	            	 ryd.getTxt_stime().setText(t);
	            }else if (btn_command.equals("结束时间")){
	            	
	            	ryd.getTxt_etime().setText(t);
	            }
	    ...
	    public MyCalenderPanel(RiYinYeSelect ryd, String btn_command)
	    {
	    	super();
	    	this.ryd = ryd;
