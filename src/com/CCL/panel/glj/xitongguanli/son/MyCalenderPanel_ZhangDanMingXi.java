...
public class MyCalenderPanel_ZhangDanMingXi extends JPanel {
    
    public static final String DATE_CHANGED = "DateChanged";
    private ZhangDanMingXiSelect zdmx;
    private String btn_command;
    ...
    private final class DayClientListener extends MouseAdapter {
        ...
        public void mousePressed(MouseEvent e) {
            ...
            ///////////////////////////////////////////////////////////////////////////////////////////////
            Date time =calendar.getTime();//获得年份，月份
            String times =DateUtil.paseDate(time);
            String t =times+"-"+text;
            if(btn_command.equals("起始时间"))
            {
            	zdmx.getTxt_stime().setText(t);
            }else if (btn_command.equals("结束时间")){
            	
            	zdmx.getTxt_etime().setText(t);
            }
     ...
     */
    public MyCalenderPanel_ZhangDanMingXi() {
        super();
    ...
    public MyCalenderPanel_ZhangDanMingXi(ZhangDanMingXiSelect zdmx, String btn_command)
    {
    	super();
    	this.zdmx = zdmx;
    	this.btn_command = btn_command;
        calendar = Calendar.getInstance();
        YEAR = calendar.get(Calendar.YEAR);
        MONTH = calendar.get(Calendar.MONTH);
        DAY = calendar.get(Calendar.DAY_OF_MONTH);
