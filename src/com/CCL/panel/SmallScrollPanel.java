...
private JButton getLeftScrollButton() {
    if (leftScrollButton == null) {
        ...
        // 创建按钮图标
        ImageIcon icon1 = new ImageIcon("images/MJBtn/zuoyidongoff.png");
        // 创建按钮图标2
        ImageIcon icon2 = new ImageIcon("images/MJBtn/zuoyidongon.png");
    ...
    private JButton getRightScrollButton() {
        if (rightScrollButton == null) {
            ...
            // 创建按钮图标
            ImageIcon icon1 = new ImageIcon("images/MJBtn/youyidongoff.png");
            // 创建按钮图标2
            ImageIcon icon2 = new ImageIcon("images/MJBtn/youyidongon.png");
            // 按钮透明
