	...
	private void initComponents() {
		...
		jTabbedPane1.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e) {
				...
				String panelTitle = jTabbedPane1.getTitleAt(selectedIndex);
				
				MainFrame.getFristLabel().setText(panelTitle);
				if (OperUserPerService.preJudgeByPanelTitle(panelTitle)==false ) {
					...
					JOptionPane.showMessageDialog(null, "您当前没有"+panelTitle+"的权限");
